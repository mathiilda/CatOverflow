<div class="w-8/12 md:w-2/3 mt-20 mb-20 mr-auto ml-auto bg-gray-100 rounded shadow p-8">
    ...
    <!-- RESPONSE ON CREATION OF QUESTION -->
    <?php if ($data["edit"]) : ?>
    ...
    <?php foreach ($questions as $q) : ?>
        ...
        <div class="rounded shadow p-8 flex flex-row w-full mb-8">
            <div class="flex flex-col w-2/24 mr-8 justify-between text-center text-2xl h-36">
                ...
                <?php else : ?>
                    <form action="questions/accept" method="GET">
                        <button type="submit" name="id" value="<?= $q->id ?>" class="btn btn-success">
